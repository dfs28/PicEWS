...
print(f'TPCN: Running with {length}h time target window, {input_length}h input window, using z-scores {no_z == False}')
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_TPCN_results_binary_pSOFA", "w")
...
results_df.to_csv('/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_TPCN_results_binary_' + file_suffix + '.csv')
...
"""
#### Now ablate bits
tf.keras.utils.plot_model(full_model, to_file='/mhome/damtp/q/dfs28/Project/PICU_project/models/1d_CNN_TPCN_binary.pdf', show_shapes=True, expand_nested = True)
tf.keras.utils.plot_model(deterioration_model, to_file='/mhome/damtp/q/dfs28/Project/PICU_project/models/1d_CNN_TPCN_binary_singleoutput.png', show_shapes=True, expand_nested = True)
#Make the final net
kernal_regulariser = bias_regulariser = tf.keras.regularizers.l2(1e-5)
#tf.keras.regularizers.l1(l1_value)
#tf.keras.regularizers.l1_l2(l1 = l1_value, l2 = l2_value)
