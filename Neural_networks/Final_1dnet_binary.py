...
print(f'1D: Running with {length}h time target window, {input_length}h input window, using z-scores {no_z == False}')
...
def make_1DNET(model_type):
    ...
    x = layers.Conv1D(20, 50, activation='relu', padding = 'same',  kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(input_timeseries)
    x = layers.Conv1D(40, 30, activation='relu', padding = 'same', kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(x)
        
    x = layers.MaxPooling1D(2, padding = 'same')(x)

    x = layers.Conv1D(120, 15, activation='relu', padding = 'same',  kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(x)
    x = layers.Conv1D(60, 20, activation='relu', padding = 'same', kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(x)
    ...
    x = layers.Conv1D(40, 30, activation='relu', padding = 'same',  kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(x)
    x = layers.Conv1D(60, 30, activation='relu', padding = 'same', kernel_initializer = init,
                    kernel_regularizer= kernal_regulariser,
                    bias_regularizer= bias_regulariser)(x)
...
a_file = open("/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_results_binary_pSOFA", "w")
...
results_df.to_csv('/mhome/damtp/q/dfs28/Project/PICU_project/files/1Dnet_results_binary_' + file_suffix + '.csv')

"""
tf.keras.utils.plot_model(full_model, to_file='/mhome/damtp/q/dfs28/Project/PICU_project/models/1d_CNN_binary.pdf', show_shapes=True, expand_nested = True)
tf.keras.utils.plot_model(deterioration_model, to_file='/mhome/damtp/q/dfs28/Project/PICU_project/models/1d_CNN_binary_singleoutput.png', show_shapes=True, expand_nested = True)
